...
function closeSideNav() {
    let boxWidth = $(".side-nav-bar .nav-tabs").outerWidth()
    $(".side-nav-bar").animate({
        left: -boxWidth
    }, 500)
...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getDetailsMeals('${arr[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 cursor-pointer">
    ...
    for(let i=0; i<arr.length; i++){
        ...
        <div class="col-md-3">
                <div onclick="getCategoryMeals('${arr[i].strCategory}')" class="meal position-relative overflow-hidden rounded-2 ">
                    ...
                    <div class="meal-layer position-absolute text-center text-black-50 p-2">
...
async function getDetailsMeals(mealId){
    closeSideNav()
    allData.innerHTML = "";
    $(".inner-loading-screen").fadeIn(300);
    searchContainer.innerHTML = "";
...
function displayMealDetails(meal){
    ...
    <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <h3 class="text-white"><span class="fw-bolder text-white">Area : </span class="text-white">${meal.strArea}</h3>
                <h3 class="text-white"><span class="fw-bolder text-white">Category : </span class="text-white">${meal.strCategory}</h3>
                <h3 class="text-white">Recipes :</h3>
                <ul class="list-unstyled d-flex g-3 text-white flex-wrap">
                    ${ingredients}
                </ul>
                ...
                <a target="_blank" href="${meal.strSource}" class="text-white btn btn-success">Source</a>
                <a target="_blank" href="${meal.strYoutube}" class="text-white btn btn-danger">Youtube</a>
            </div>`
